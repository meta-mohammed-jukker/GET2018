package com.metacube.training.AdminEmployeePortalWithSpringSecurity.configuration;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter
{
            ...
            throws Exception
    {
        ...
        auth.inMemoryAuthentication().withUser("mohammed.jukker@metacube.com")
    ...
    protected void configure(HttpSecurity http) throws Exception
    {
        ...
        http.authorizeRequests().antMatchers("/admin/*")
                ...
                .passwordParameter("password").failureUrl("/error").and().logout()
                .logoutUrl("/logout")
