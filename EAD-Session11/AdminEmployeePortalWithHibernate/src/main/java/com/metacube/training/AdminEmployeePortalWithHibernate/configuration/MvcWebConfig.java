package com.metacube.training.AdminEmployeePortalWithHibernate.configuration;
...
public class MvcWebConfig implements WebMvcConfigurer
{
    ...
    public LocalSessionFactoryBean getSessionFactory()
    {
        ...
        factoryBean.setAnnotatedClasses(Project.class, Employee.class,
                Job.class, Skill.class, EmployeeSkillMapping.class);
